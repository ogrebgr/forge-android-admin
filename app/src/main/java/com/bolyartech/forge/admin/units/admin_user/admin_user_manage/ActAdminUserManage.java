...
public class ActAdminUserManage extends SessionActivity<ResAdminUserManage> implements
    ...
    @Inject
    Provider<ResAdminUserManageImpl> mRes_AdminUserManageImplProvider;
    ...
    @NonNull
    @Override
    public ResAdminUserManage createResidentComponent() {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.ab_disable) {
            ...
            Intent intent = new Intent(this, ActAdminUserChpwd.class);
            intent.putExtra(ActAdminUserChpwd.PARAM_USER_ID, mUser.getId());
